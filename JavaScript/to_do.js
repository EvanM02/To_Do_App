...
function add() {
    ...
    show();
    // this refreshes the page so that you don't have to. 
    //after the page is refreshed you can delete items in the array. 
...
function remove() {
    ...
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
   // this bit of jquery refreshes the page so you don't have to manually do it,
   // and then you can keep deleting items in the array. 
    $('#todos').click(function() {
        location.reload();
    });

    /* this looks in the show() how to display removed item on the screen */
    show();
